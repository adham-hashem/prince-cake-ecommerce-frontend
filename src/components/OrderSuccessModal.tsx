...
const OrderSuccessModal: React.FC<OrderSuccessModalProps> = ({
  ...
  useEffect(() => {
    console.log('OrderSuccessModal - isOpen changed to:', isOpen);
    if (isOpen) {
      console.log('✅ Modal is now OPEN - should be visible!');
  ...
  console.log('OrderSuccessModal render - isOpen:', isOpen);
  if (!isOpen) {
